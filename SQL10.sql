...
SELECT table_students.name AS name_student, ROUND(AVG(table_grades.score),2) as avg_score from students AS table_students
...
SELECT table_students.name AS name_student, subjects.name_subject, ROUND(AVG(grades.score),2) AS average_score FROM students AS table_students
